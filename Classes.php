...
class FileDownload
{
    private $pointer,$mime,$extension,$name,$size;
    ...
    public function sendDownload($forceDownload=true)
    {
        ...
        rewind($this->pointer);
        fpassthru($this->pointer);
    }

    private function getMimeType()
    {
        $mime=Mimes::fromExtension($this->extension);
        return !is_null($mime)?$mime:"application/force-download";
    }
